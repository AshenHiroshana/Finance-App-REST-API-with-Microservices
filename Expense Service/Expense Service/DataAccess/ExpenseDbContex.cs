...
namespace Expense_Service.DataAccess
{
    public class ExpenseDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            var connectionString = "Server=tcp:expenseservicedbserver.database.windows.net,1433;Initial Catalog=Expense Service_db;Persist Security Info=False;User ID=Ashen;Password=Earth1234@;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
